...
class MyMainWindow(QFrame):
    ...
    def initPath(self):
        ...
        self.selectDateUrl = r'https://sellercentral.amazon.co.jp/gp/orders-v2/search/ref=ag_myosearch_apsearch_myo?language=en_JP&languageSwitched=1'
        self.getThreadUrl = r'https://sellercentral.amazon.co.jp/messaging/inbox/ref=ag_cmin_head_myosrch?cs=1222219038&fi=RESPONSE_NEEDED&pn=1'
